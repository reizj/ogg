...
document.querySelector(".blow-button").addEventListener('click', function () {
  Swal.fire({
    title: 'hbd og!',
    text: 'Virtual cake muna kasi ayaw mo naman real cake. Sa susunod nalang yon kapag may work na. Mag-aral ka nang mabuti, and if naiisip mo na naman na hindi mo na kaya, lagi mong tatandaan na mag-layout pa ako ng tarpaulin mo. Alam kong kayang-kaya mo yon. Basta alam mo na yan og, matic basta ikaw. Enjoy your day! Ingat ka lagi og! ',
    iconHtml: `
